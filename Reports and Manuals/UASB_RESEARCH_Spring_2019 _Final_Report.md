...
Below is a formal, more detailed list of the goals of UASB-R this semester:
...
Based on the sketch in Figure 12, the red section represents a wastewater tank that holds wastewater before entering the tipping bucket, and the black box located on the bottom of the drawing is the four pipe outlet system that deliver the waste water evenly to the sludge blanket reactor. The system can be called the "flow distribution system".
