...
Thus, it is of utmost importance to balance the results of the two studies, and design a UASB reactor that has velocities low enough to ensure optimal treatment, but high enough to positively impact granulation of the sludge blanket.
...
In the fall semester of 2018, the team aimed to finalize the UASB reactor design before fabrication. While the entire design could not be finalized due to unexpected complications in the design process, the team began to address this goal with bench top tests to study the flow patterns through sludge. Tapioca was chosen to model sludge because tapioca and sludge have similar material properties. The goal of these tests was to inform the team about possible failure conditions within the model UASB reactor, which was achieved reasonably well.

Another goal for the Fall 2018 semester was to write code to model designs of the reactor. Since the UASB reactor can have many design approaches, it is important to create flexible code that can test different positions and determine the required parameters. This semester, the team started writing the code to determine the dimensions of the effluent tube of the model reactor — a task that will continue on to early spring 2019.

Because AguaClara has moved from Fusion 360 to Onshape, UASB also aimed to create an updated CAD model of the UASB reactor on OnShape with the help of the subteam AIDE Template. However, due to a shortage of members on AIDE Template, this task will have to be pushed to the following semester.

The final goal for the team in the fall 2018 semester was to begin prepping for fabrication. This includes locating and ordering materials, making fabrication and safety plans, and learning fabrication techniques such as plastic welding. The team successfully fabricated a model reactor for benchtop testing within the lab, and intends to apply the skills learned this semester to fabricate a full-size UASB reactor next semester.
...
<p align="center">Fig. 1: Lab scale model UASB reactor<p>
...
<p align="center">Fig. 2: Lab scale model UASB reactor<p>
...
<p align="center">Fig. 3: State list for Tapioca Test<p align="center">
...
<p align="center">Fig. 4: ProCoDa Setup for experiments<p align="center">
...
<p align="center">Fig. 9: Chia seeds forming uneven clumps within the lab UASB reactor<p>
...
<p align="center">Fig. 10: Dye tests in the lab UASB reactor filled with marbles<p>

The glass marbles were about 1 cm in diameter. They did not work as a model for sludge granules because they were far too heavy for the influent water to lift them. While the glass marbles were not useful for modeling the sludge blanket, they did give the team the opportunity to use the photometer to measure the red dye concentration of water in the model UASB effluent.
...
<p align="center">Fig. 11: Flow chart used in the Gates Grant proposal<p>

The proposal can be read [here](https://github.com/AguaClara/UASB/blob/master/README.md).

# Future Work

While quite a lot was accomplished this semester, UASB discovered that there are still a lot of elements of the UASB reactor that need to be researched and finalized within a short amount of time; therefore, the team structure will most likely be changing next semester. In the final weeks, the team decided that the main priority for next semester is the design and fabrication of the UASB reactor.  While research about fluid movement within the reactor is still valuable in observing how of how UASB reactors work, the focus of the team should be to create a working prototype to test in the Ithaca wastewater treatment plant.  As such, the team recommends that the main UASB team completely focus on design, and if there is room for another team created, we will recruit a full research team to continue the research work done this semester.

### Design Team Goals

The main task for the fabrication team will be to finish design of the UASB reactor, create a CAD model in OnShape, and begin fabrication so the UASB reactors can be installed in the IAWWTF. This will primarily involve writing flexible design code that incorporates many parts of the UASB system together and runs calculations for all of them. It would be preferred to have members with experience in fabrication and with CAD software.

### Research Team Goals

The main task for the research team is to continue the testing done this semester. This includes reducing preferential pathways, working on the influent design, and integrating the tipping bucket system worked on during the summer into the design. The research team will also work alongside the Design team and help test various reactor components in the lab during the fabrication process. Members of this team will ideally have some experience with fluid mechanics and lab research in AguaClara.
