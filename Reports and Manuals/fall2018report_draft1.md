...
Over the summer of 2018, the UASB team's main goal has been to finish a UASB wastewater treatment system design and fabricate an influent system. This semester, the team will focus on conducting benchtop tests to study flow patterns within the reactor and completing the UASB design.
...
Organic matter in wastewater is broken down by bacteria that feed on it, consuming oxygen in the process. Depletion of dissolved oxygen levels in water can threaten aquatic life and cause fish kills.
Additionally, nutrients such as nitrogen and phosphorus contained in wastewater can lead to explosive algal growth in waterways, which also depletes oxygen levels and can create dead zones through a process known as [eutrophication](https://oceanservice.noaa.gov/facts/eutrophication.html). Finally, fecal matter in wastewater can cause the spread of infectious waterborne diseases like cholera, salmonella, and diarrhea.
...
UASB reactors are used for primary treatment and clarify wastewater by removing suspended solids organic matter ([Chong et. al, 2012](https://www.sciencedirect.com/science/article/pii/S0043135412002400?via%3Dihub)). Organic carbon in the wastewater moving up through the sludge blanket is consumed by the microbes residing within the sludge.
UASB reactors rely on gravity to clarify wastewater and biological processes to remove organic matter and convert it to biogas. They are less energy intensive than other forms of preliminary wastewater treatment that use aerobic processes. UASB reactors also produce methane as a by-product of anaerobic digestion.  This methane can be captured and burned for energy production or heating.
...
This summer, we created a Computer Aided Design (CAD) model of our UASB, accomplished through the use of Fusion 360. We decided the best way to deliver wasterwater to our UASB was to use a to tipping bucket system, because it's not complicated to manufacture, uses parts that are both easy to obtain and are fairly low cost, and because designs from similar systems are easy to obtain. We determined hydraulic parameters, created code for our influent system parameters, and debated various methods of collecting biogas produced by the bacteria in the sludge blanket. A model of the tipping bucket system was created after we had finished testing of prototypes, adjusting the geometry of the system as we went. We preformed bench top tests and recorded the flow patterns in the tank. Lastly we also found a place to build our UASB, but that has changed (see next paragraph).

This semester, our team has been finalizing our designs for our UASB system. We are on track, so far, to begin to expand from our model into a full-fledged UASB system before the semester ends. But first, we will be performing tests of the effectiveness of our reactor by modeling the sludge blanket with tapioca. This will allow us the get a feel for the reactor and tweak our design as we go, without having to worry about live bacteria just yet. We may also make a new CAD model of our design (using OnShape), but that has yet to be decided. Also, we have been consulting with Dr. Monroe and Prof. Edwin Cowen, as well as researching similar UASB experiments done both at home and abroad, for how to make our system as efficient as possible and determining final qualities of the reactor, such as the dimensions of the tank, upflow velocity, thickness of sludge blanket, number of influent pipes, etc. Trial-and-error through our tapioca tests, however, will be the final determination. Once we feel we have modeled the optimum system, we will build our reactor at the Ithaca Area Wastewater Plant, which has graciously offered us a lead-free room in their building. This may possibly be done by first building sections of the reactor at the lab and then moving them to the Plant for final construction.
