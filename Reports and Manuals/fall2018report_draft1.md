...
For summer 2018 (to be written 9/28 I'm currently too dead :) -Cara
This summer, we created a Computer Aided Design (CAD) model of our UASB, accomplished through the use of Fusion 360. We decided the best way to deliver wasterwater to our UASB was to use a to tipping bucket system, because it's not complicated to manufacture, and uses parts that are both easy to obtain and are fairly low cost. And designs from similar systems are easy to obtain. We determined hydraulic parameters, as well as created code for our influent system parameters. We created a model of the tipping bucket system, adjusting the geometry of the system as we went. We also found a place to build our UASB, but that has changed.
