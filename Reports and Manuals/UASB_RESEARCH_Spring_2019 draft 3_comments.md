...
A clear PVC sheet was used to fabricate this system, so the team could observe what happens inside the tank. The tank was fabricated using the xxxxxxx plastic containers, and the four pipes outlet system was fabricated using half inch thick plastic sheet. The plastic sheet was cut into squares with a perimeter of 3" and with a total of five sides. The four sides were for the wall, and the other side was used to enclose the bottom of the box. The four pieces of cut plastic then were glued together using PVC glue. The four 1/2 inch  diameter holes are drilled into the bottom and then four of 1/2 inches pipes are attach into them.
