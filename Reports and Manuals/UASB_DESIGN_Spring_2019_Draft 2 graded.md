...
During Spring 2019, the UASB-Design team's main goal will be **[I know Felix said to do future tense, but that isn't right (we discussed it). Please change it back!! Everything should be past tense when talked about this semester's or prior semester's work. Thanks for understanding and sorry guys.]** to  finalize the design for the UASB and support the design with substantial Python code and CAD designs. So far, the team has completed a general CAD design on Onshape for the entire UASB reactor.

##Introduction
In the past, AguaClara has focused on creating sustainable and inexpensive drinking water treatment; however, it is currently expanding to wastewater treatment. Previously, AguaClara has struggled in finding the demand for wastewater treatment plants in Nicaragua or Honduras. This was due to the difficulty in explaining the importance of investing a substantial amount into a system that would not directly affect the health of the people in the community. Now that it has become more apparent of the important, and receiving funding from EPA, AguaClara can now develop their wastewater systems, including the completion of a pilot UASB reactor. **[This sentence has grammar mistakes and is stylistically difficult to read. Please revise.]** The pilot UASB reactor will be tested with influent wastewater entering Ithaca Area Wastewater Treatment Facility (IAWWTF), which  will be a big step for AguaClara’s venture into sustainable wastewater treatment.

 In an UASB reactor, wastewater will flow through a sludge blanket, composed of millions of methane-producing bacteria which will consume many of the organic pollutants in the water. As a result, wastewater can now be recycled for recreational activities and put back into the environment safely. There is still much that needs to be further discovered and refined, such as whether or not the tipping bucket system will be useful in eliminating preferential pathways, the effluent system design, and the methane gas capture system.
...
**[Use past tense when talking about current or previous semester's work]** In the Spring 2019 semester, the team will focus on finalizing the UASB pilot-scale reactor design which will be tested in Ithaca’s Wastewater Treatment Plant by the Summer of 2020.
...
A design for the tipping bucket was completed by the summer 2018 team. **[Refer to your figure in the text.]**
